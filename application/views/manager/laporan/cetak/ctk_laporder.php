        ...
        <tr>
            <td>
                <div class="logos" style="margin-left:100px;margin-top:-10px;position:absolute;">
                    <img src="<?= base_url(); ?>/assets/images/img/aw.png" width="100" height="90" alt="ok" />
                    <small style="margin-left: -120px;margin-top:20px;">Restaurant Khas Amerika</small>
                </div>
                <div align="center">
