...
<head>
	...
	<title>Login | A&W Restaurant Mall Ciputra</title>
	<meta charset="utf-8">
	...
	<!-- Favicon icon -->
	<link rel="icon" href="assets/src-login/images/favicon.png" type="image/x-icon">
	<!-- fontawesome icon -->
	...
	<div class="auth-content container">
		<div class="card">
			<div class="row align-items-center">
				<div class="col-md-6">
					<div class="card-body">
						<img src="assets/src-login/images/logo-aw.png" width="70%" alt="" class="img-fluid mb-4">
				...
				<div class="col-md-6 d-none d-md-block">
					<img src="assets/src-login/images/auth-bg.jpg" width="97%" alt="" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
