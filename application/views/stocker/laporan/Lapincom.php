                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <span style="margin-left: 10px;">
                                        ...
                                        <a href="<?php echo base_url(); ?>stocker/lapincom/pdf" class="btn btn-xs btn-rounded btn-bordered btn-danger"><i class="fa fa-download"></i> Export PDF</a>

                                        <!-- Link Untuk Report Quality Supply -->
                                        <?php
                                        if ($this->session->userdata('tg1') == "") {
                                            echo '<a data-toggle="modal" data-target="#modal" class="btn btn-xs btn-rounded btn-bordered btn-success"><i class="fa fa-file-pdf-o"></i> Report Quality Supply</a>';
                                        } else {
                                            echo '<a data-toggle="modal" data-target="#modalrqs" class="btn btn-xs btn-rounded btn-bordered btn-success"><i class="fa fa-file-pdf-o"></i> Report Quality Supply</a>';
                                        }
                                        ?>
                                    </span>
                                    <?php echo form_close(); ?>
