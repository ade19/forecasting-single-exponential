                ...
                <div class="box-content card white">
                    ...
                    <div class="card-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" value="<?= $autokode ?>" id="kode" name="kode" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="gdg" class="col-sm-2 control-label">No. Rak Gudang</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="gdg" name="gdg" placeholder="Ex: YMH2" required>
                            </div>
                        </div>
                        <div class="form-group">
