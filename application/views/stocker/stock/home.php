                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($dp['quality'] < 1) {
                                            echo '<button class="btn btn-rounded btn-sm btn-danger">' . $dp["status"] . '</button>';
                                        } else if ($dp['quality'] > $dp['min_stock']) {
                                            echo '<button class="btn btn-rounded btn-sm btn-success">' . $dp["status"] . '</button>';
                                        } else {
                                            echo '<button class="btn btn-rounded btn-sm btn-warning">' . $dp["status"] . '</button>';
                                        } ?>
                                    </td>
                                </tr>
                            <?php
