...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?= base_url(); ?>assets/src-login/images/favicon.png" type="image/x-icon">

    <title>Dashboard | A&W Restaurant Mall Ciputra</title>
    ...
    <!-- Morris Chart -->
    <link rel="stylesheet" href="<?= base_url(); ?>assets/plugin/chart/morris/morris.css">
...
<body onload="changeValue(kodeb.value);">